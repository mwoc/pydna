...
class MyModel(model.DnaModel):
    ...
    def init(self):
        ...
        self.addComponent(com.Splitter, 'split2').nodes(12, 13, 41)
    ...
    def run(self):
        ...
        self.nodes['15.1']['t'] = t_sat + 1 # Pump will add some heat
        ...
        self.nodes['44.1']['t'] = t_sat + 1 # Pump will add some heat
